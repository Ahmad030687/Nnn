...
≿━━━━༺❀༻━━━━≾`;
  ...
  if (event.body?.toLowerCase() === "owner") {
    ...
    return api.sendMessage(
      ...
      decorate("💝🥀 𝗢𝗪𝗡𝗘𝗥:𝐀𝐇𝐌𝐀𝐃 𝐑𝐃𝐗 💫\n🖤 You can call him 𝗔𝗛𝗠𝗔𝗗 𝗥𝗗𝗫 🖤\n📌 Facebook: https://www.facebook.com/profile.php?id=61577631137537\n📩 Telegram: @alijanhunyaar"),
  ...
  if (event.body?.toLowerCase() === "who created you" || event.body?.toLowerCase() === "creator") {
    ...
    return api.sendMessage(
      ...
      decorate("❤️ My creator is 𝐀𝐇𝐌𝐀𝐃 𝐑𝐃𝐗. He edits me daily and made me to spread happiness."),
